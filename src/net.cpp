...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hugcoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"hugcointools.com", "testnet-seed.hugcointools.com"},
...
unsigned int pnSeed[] =
{
    0xad39fa63, 0x99022859, 0x55e6b723, 0x44db1003, 0xab08b12
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hugcoin is probably already running."), addrBind.ToString().c_str());
        else
